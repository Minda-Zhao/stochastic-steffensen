...
plt.semilogy(error_ssbb, linewidth=2, label='b = 16', marker='^', color='g')
...
plt.xlim((0, 30))
plt.ylim((1e-17, 1))
plt.savefig('./plot/hinge/batch.png')
plt.show()
...
for i in range(repeat):
    w_path_sgd, time_stamp_sgd = alg.sgd(func_sto, initial_w, epoch_sgd, m, 0.1, b, n)
...
plt.xlim((0, 60))
plt.ylim((1e-16, 1))
plt.savefig('./plot/hinge/passes.png')
plt.show()
...
plt.xlim((0, 7))
plt.ylim((1e-16, 1))
plt.savefig('./plot/hinge/time.png')
plt.show()